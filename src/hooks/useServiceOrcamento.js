  ...
  return {
    submit: async () => {
      try {
        ...
        const URL = `https://docs.google.com/forms/d/e/1FAIpQLSeVgF8xsZp_KWO12M9_c-lEDNM-oG2vS9c4FWPSYn3arBW8IQ/viewform?usp=pp_url&entry.1839056621=${formValues.entryName}&entry.1605181147=${formValues.entryAge}&entry.956957064=${formValues.entryOccupancy}&entry.1689608432=${formValues.entryWhatsapp}&entry.1090549890=${formValues.entryHowYouMet}&entry.734680111=${formValues.entryProjectCity}&entry.1092662459=${formValues.entryProjectBuilt}&entry.547802146=${formValues.entryProjectType}&entry.570513031=${formValues.entryProjectArea}&entry.722497747=${formValues.entryProjectEnvironment}&entry.48717484=${formValues.entryProjectPlace === "Outros" ? formValues.entryProjectPlaceOther : formValues.entryProjectPlace}&entry.390066382=${formValues.entryProjectRevestimentos === "Outros" ? formValues.entryProjectRevestimentosOther : formValues.entryProjectRevestimentos}&entry.122732658=${formValues.entryProjectForro === "Outros" ? formValues.entryProjectForroOther : formValues.entryProjectForro}&entry.2123598535=${formValues.entryFinalsMoveis}&entry.316321790=${formValues.entryStyle}&entry.1058871605=${formValues.entryFinalsNotes}&submit=Submit`;
